...
3 papers appear to stand out, apart from the rest, with a theta close to 1: Yomiuri, Nikkei and Sankei. 
According to Kaneko's et all's review, these three newspaper correspond to the three national, high-circulation and right-leaning papers. On the other end of the spectrum, Chunichi and Asahi are considered left-leaning, which suggests that the wordfish model has captured a left-rigth dimension, although Mainichi is also considered left and appears in the middle rather than to the left of the theta x-axis. This could support Abe (2015)'s findings, reported in the article, that Mainichi is in fact closer to the centre than to the left of the political spectrum. The group of 5 papers around the middle of our plot comprises otherwise liberal and regional newspapers (e.g. Hokkaido and Chunichi)
...
I can't read Japanese characters so I have no idea what words are important here. Can't really interpret much. 
